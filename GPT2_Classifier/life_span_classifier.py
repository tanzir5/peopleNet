...
def create_pairs_dataset(path):
    ...
    for i in range(0, len(masked_text)-1, 2):
        ...
        if shorter_goes_first:
            ...
            pair_texts.append("Person 0: " + shorter_text +  "\nPerson 1: " + longer_text)
            pair_labels.append(0)
            span_diffs.append(longer_span - shorter_span)
        else:
            shorter_goes_first = True
            pair_texts.append("Person 0: " + longer_text +  "\nPerson 1: " + shorter_text)
...
trainer.train()
trainer.save_model("classifier_trainer/best")
